...
//             static_cast<int32_t>(round(1.0 / 10 * maxSpeed));
...
//         ConnectorM1.MotorInAState(false);
//         ConnectorM2.MotorInAState(false);
//         ConnectorM3.MotorInAState(false);
//     }
//     else {
//         ConnectorM0.MotorInAState(true);
//         ConnectorM1.MotorInAState(true);
//         ConnectorM2.MotorInAState(true);
//         ConnectorM3.MotorInAState(true);
//     }
...
//     // Command the move.
//     ConnectorM0.MotorInBDuty(dutyRequest);
//     ConnectorM1.MotorInBDuty(dutyRequest);
//     ConnectorM2.MotorInBDuty(dutyRequest);
//     ConnectorM3.MotorInBDuty(dutyRequest);
